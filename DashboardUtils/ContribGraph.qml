...
Rectangle {
    ...
    function organiseGridData() {
        ...
        for (let w = 0; w < totalWeeks; ++w) {
            weekGrid[w] = [];
            for (let d = 0; d < 7; ++d) weekGrid[w][d] = {
                "level": 0,
                "count": 0,
                "date": ""
            }
        ...
        let columnFirst = [];
        for (let w = 0; w < weekGrid.length; ++w) for (let d = 0; d < 7; ++d) columnFirst.push(weekGrid[w][d])
        ...
        stdout: SplitParser {
            onRead: (data) => {
                ...
                try {
                    ...
                    contributionData = rsp.contributions.filter((d) => {
                ...
                Repeater {
                    ...
                    Rectangle {
                        ...
                        color: {
                            switch (day.level) {
                            case 0:
                                return Theme.Colors.conlevel1;
                            case 1:
                                return Theme.Colors.conlevel2;
                            case 2:
                                return Theme.Colors.conlevel3;
                            case 3:
                                return Theme.Colors.conlevel4;
                            case 4:
                                return Theme.Colors.conlevel5;
                            default:
                                return Theme.Colors.conlevel1;
                            }
                        }
